...
- Добавить в README или в сопроводительное сообщение скриншот Telegram-уведомления.
- При желании подключить GitHub integration в Vercel, чтобы следующие деплои шли через push, а не через ручной CLI deploy.
